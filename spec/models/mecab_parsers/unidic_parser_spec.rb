RSpec.describe MecabParsers::UnidicParser, type: :model do
  describe '#extract_base_form' do
    it '基本形が存在する場合はそれを返す' do
      surface = '走った'
      features = [ '動詞', '自立', '*', '*', '五段・ラ行', '過去形', '走る', 'ハシッタ', 'ハシッタ', '*', '走る' ]
